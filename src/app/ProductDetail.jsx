  ...
  return (
    <main>
      <div className="details-display">
        ...
        <Image className="details-image" src="/images/details1.png" width={152} height={167} alt="" />
        <Image className="details-image" src="/images/details2.png" width={152} height={167} alt="" />
        <Image className="details-image" src="/images/details3.png" width={152} height={167} alt="" />
        <Image className="details-image" src="/images/details4.png" width={152} height={167} alt="" />
        </div>
        <div className="product-details">
          ...
          <div className="quantity">
            ...
            <Image src="/images/minus.png" width={24} height={24} alt="" />
              <p>1</p>
              <Image src="/images/plug.png" width={24} height={24} alt="" />
            </div>
